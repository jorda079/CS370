...
def handle_request():
    ...
    try:
        ...
        # Print the averages
        logger.debug(f'Movie 1 Averages: O1 = {movie_1_avg_O1}, O2 = {movie_1_avg_O2}, T3 = {movie_1_avg_T3}, T4 = {movie_1_avg_T4}\n')

        # Call the function to calculate averages
        movie_2_avg_O1, movie_2_avg_O2, movie_2_avg_T3, movie_2_avg_T4 = calculate_average_user_data(movie_2_read)
        # Print the averages
        logger.debug(f'Movie 2 Averages: O1 = {movie_2_avg_O1}, O2 = {movie_2_avg_O2}, T3 = {movie_2_avg_T3}, T4 = {movie_2_avg_T4}\n')

        # Call the function to calculate averages
        movie_3_avg_O1, movie_3_avg_O2, movie_3_avg_T3, movie_3_avg_T4 = calculate_average_user_data(movie_3_read)
        # Print the averages
        logger.debug(f'Movie 3 Averages: O1 = {movie_3_avg_O1}, O2 = {movie_3_avg_O2}, T3 = {movie_3_avg_T3}, T4 = {movie_3_avg_T4}\n')
